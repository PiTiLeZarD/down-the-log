...
import { useNotificationTaps } from "../lib/utils/use-notification-taps";
...
const RootLayout = () => {
    ...
    useSpotConfig();
    // Routes a tapped spot alert to the Spots page on iOS and Android; a no-op everywhere else.
    useNotificationTaps();
