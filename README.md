...
The demo is an installable PWA — "Add to Home Screen" on iOS/Android or the install button in a desktop browser gets you a standalone window that works offline (your log lives in local storage; only callsign lookups, geocoding and the propagation panel need the network).
